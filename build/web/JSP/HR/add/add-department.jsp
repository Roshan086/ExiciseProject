        ...
        <div id="wrapper">
            ...
            <div class="main">
                ...
                <div class="main-content">
                    ...
                    <h4> Add Employee </h4>
                    <hr>
                    <s:form theme="simple" action="addDepartment">
                        ...
                        <s:div cssClass="form-group">
                            <s:submit value="Add" method="addDepartment" cssClass="btn btn-primary"> </s:submit>
                        </s:div> 

                    </s:form>
                    <div style="float:left; transform: translate(80px,-48px)">
